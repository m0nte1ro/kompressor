...
export const bitrate = value => value == null ? '—' : `${value / 1e6} Mbps`;
export const label = value => ({cpu: 'CPU · x265', qsv: 'Intel QSV', hevc: 'HEVC', h264: 'H.264',
  ...
  preserve_source: 'Preserve source HDR mode', tone_map_to_sdr: 'Tone map HDR to SDR', hdr10: 'HDR10', hdr10plus: 'HDR10+', hlg: 'HLG', unknown: 'Unknown',
